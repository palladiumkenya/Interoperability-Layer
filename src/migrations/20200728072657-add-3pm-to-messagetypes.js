...
module.exports = {
  ...
  down: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.query(`DELETE FROM messagetypes WHERE name = '3PM^ADX';`)
  }
};
